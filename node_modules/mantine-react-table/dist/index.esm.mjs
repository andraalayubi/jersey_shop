...
import { useState, useMemo, useReducer, useRef, useEffect, useCallback, memo, Fragment as Fragment$1, createElement, useLayoutEffect } from 'react';
import { jsx, jsxs, Fragment } from 'react/jsx-runtime';
import { Box, Tooltip, ActionIcon, Button, Menu, useDirection, Flex, Switch, Radio, Checkbox, Highlight, CopyButton, UnstyledButton, Select, TextInput, TableTd, Skeleton, TableTr, Collapse, TableTbody, Text, TableTh, TableTfoot, Badge, MultiSelect, Autocomplete, RangeSlider, Popover, Transition, Indicator, Alert, Stack, TableThead, useMantineColorScheme, Table, lighten, darken, Modal, LoadingOverlay, Progress, Group, Pagination, useMantineTheme, Divider, Paper } from '@mantine/core';
...
const MRT_GrabHandleButton = ({ actionIconProps, onDragEnd, onDragStart, table: { options: { icons: { IconGripHorizontal }, localization: { move }, }, }, }) => {
    ...
    return (jsx(Tooltip, { label: (_a = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _a !== void 0 ? _a : move, openDelay: 1000, withinPortal: true, children: jsx(ActionIcon, Object.assign({ "aria-label": (_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _b !== void 0 ? _b : move, draggable: true }, actionIconProps, { className: clsx('mrt-grab-handle-button', classes$B['grab-icon'], actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.className), color: "gray", onClick: (e) => {
            ...
            }, onDragEnd: onDragEnd, onDragStart: onDragStart, title: undefined, variant: "transparent", children: jsx(IconGripHorizontal, {}) })) }));
};
...
const MRT_ExpandButton = (_a) => {
    ...
    return (jsx(Tooltip, { disabled: !canExpand && !DetailPanel, label: ((_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _b !== void 0 ? _b : isExpanded)
            ? localization.collapse
            : localization.expand, openDelay: 1000, withinPortal: true, children: jsx(ActionIcon, Object.assign({ "aria-label": localization.expand, color: "gray", disabled: !canExpand && !DetailPanel, variant: "subtle" }, actionIconProps, { __vars: {
...
const getMRT_RowSelectColumnDef = (tableOptions) => {
    ...
    return Object.assign({ Cell: ({ renderedRowIndex, row, table }) => (jsx(MRT_SelectCheckbox, { renderedRowIndex: renderedRowIndex, row: row, table: table })), Header: enableSelectAll && enableMultiRowSelection
...
const MRT_TableBodyCell = (_a) => {
    ...
    return (jsx(TableTd, Object.assign({ "data-column-pinned": isColumnPinned || undefined, "data-dragging-column": isDraggingColumn || undefined, "data-first-right-pinned": (isColumnPinned === 'right' &&
            ...
            classes$t['root-editable-hover'], columnDefType === 'data' && classes$t['root-data-col'], density === 'xs' && classes$t['root-nowrap'], tableCellProps === null || tableCellProps === void 0 ? void 0 : tableCellProps.className), onDoubleClick: handleDoubleClick, onDragEnter: handleDragEnter, style: (theme) => (Object.assign(Object.assign({}, widthStyles), parseFromValuesOrFunc(tableCellProps.style, theme))), children: (_d = tableCellProps.children) !== null && _d !== void 0 ? _d : (jsxs(Fragment, { children: [cell.getIsPlaceholder() ? ((_f = (_e = columnDef.PlaceholderCell) === null || _e === void 0 ? void 0 : _e.call(columnDef, { cell, column, row, table })) !== null && _f !== void 0 ? _f : null) : showSkeletons !== false && (isLoading || showSkeletons) ? (jsx(Skeleton, Object.assign({ height: 20, width: skeletonWidth }, skeletonProps))) : columnDefType === 'display' &&
                    ...
                    rowRef }, cellValueProps))) : isCreating || isEditing ? (jsx(MRT_EditCellTextInput, { cell: cell, table: table })) : showClickToCopyButton && columnDef.enableClickToCopy !== false ? (jsx(MRT_CopyButton, { cell: cell, table: table, children: jsx(MRT_TableBodyCellValue, Object.assign({}, cellValueProps)) })) : (jsx(MRT_TableBodyCellValue, Object.assign({}, cellValueProps))), cell.getIsGrouped() && !columnDef.GroupedCell && (jsxs(Fragment, { children: [" (", (_h = row.subRows) === null || _h === void 0 ? void 0 : _h.length, ")"] }))] })) })));
};
    ...
    return (jsxs(Fragment, { children: [!(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes('sticky')) &&
                getIsSomeRowsPinned('top') && (jsx(TableTbody, Object.assign({}, tableBodyProps, { __vars: Object.assign({ '--mrt-table-head-height': `${tableHeadHeight}` }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), className: clsx(classes$v.pinned, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$v['root-grid'], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), children: getTopRows().map((row, renderedRowIndex) => {
                    ...
                    return memoMode === 'rows' ? (jsx(Memo_MRT_TableBodyRow, Object.assign({}, rowProps), row.id)) : (jsx(MRT_TableBodyRow, Object.assign({}, rowProps), row.id));
                        ...
                        : undefined }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), className: clsx(classes$v.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$v['root-grid'], !rows.length && classes$v['root-no-rows'], rowVirtualizer && classes$v['root-virtualized'], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), children: (_d = tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.children) !== null && _d !== void 0 ? _d : (!rows.length ? (jsx("tr", { className: clsx('mrt-table-body-row', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$v['empty-row-tr-grid']), children: jsx("td", { className: clsx('mrt-table-body-cell', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) &&
                            classes$v['empty-row-td-grid']), colSpan: table.getVisibleLeafColumns().length, children: (_e = renderEmptyRowsFallback === null || renderEmptyRowsFallback === void 0 ? void 0 : renderEmptyRowsFallback({ table })) !== null && _e !== void 0 ? _e : (jsx(Text, { __vars: {
                                ...
                                : localization.noRecordsToDisplay })) }) })) : (jsx(Fragment, { children: (virtualRows !== null && virtualRows !== void 0 ? virtualRows : rows).map((rowOrVirtualRow, renderedRowIndex) => {
                        if (rowVirtualizer) {
...
const MRT_FilterTextInput = (_a) => {
    ...
    if (columnDef.Filter) {
        return (jsx(Fragment, { children: (_e = columnDef.Filter) === null || _e === void 0 ? void 0 : _e.call(columnDef, { column, header, rangeFilterIndex, table }) }));
    }
    ...
    const ClearButton = filterValue ? (jsx(ActionIcon, { "aria-label": localization.clearFilter, color: "var(--mantine-color-gray-7)", onClick: handleClear, size: "sm", title: (_f = localization.clearFilter) !== null && _f !== void 0 ? _f : '', variant: "transparent", children: jsx(IconX, {}) })) : null;
    return filterChipLabel ? (jsx(Box, { style: commonProps.style, children: jsx(Badge, { className: classes$h['filter-chip-badge'], onClick: handleClearEmptyFilterChip, rightSection: ClearButton, size: "lg", children: filterChipLabel }) })) : isMultiSelectFilter ? (jsx(MultiSelect, Object.assign({}, commonProps, { searchable: true }, multiSelectProps, { className: clsx(className, multiSelectProps.className), data: filterSelectOptions, onChange: (value) => setFilterValue(value), ref: (node) => {
            if (node) {
        ...
        }, style: commonProps.style }))) : isDateFilter ? (jsx(DateInput, Object.assign({}, commonProps, { allowDeselect: true, clearable: true, popoverProps: { withinPortal: columnFilterDisplayMode !== 'popover' } }, dateInputProps, { className: clsx(className, dateInputProps.className), ref: (node) => {
            if (node) {
                filterInputRefs.current[`${column.id}-${rangeFilterIndex !== null && rangeFilterIndex !== void 0 ? rangeFilterIndex : 0}`] =
                    node;
...
const MRT_TableHeadCellFilterLabel = (_a) => {
    ...
    const filterTooltip = columnFilterDisplayMode === 'popover' && !isFilterActive
        ...
        : localization.filteringByColumn
            ...
            : column.getFilterValue()}"`)
            .replace('" "', '');
    return (jsx(Fragment, { children: jsxs(Popover, { keepMounted: columnDef.filterVariant === 'range-slider', onClose: () => setPopoverOpened(false), opened: popoverOpened, position: "top", shadow: "xl", width: 360, withinPortal: true, children: [jsx(Transition, { mounted: columnFilterDisplayMode === 'popover' ||
                        ...
                        (isRangeFilter &&
                            (!!((_c = column.getFilterValue()) === null || _c === void 0 ? void 0 : _c[0]) ||
                                ...
                                } }, rest, { children: jsx(IconFilter, { size: "100%" }) })) }) })) }), columnFilterDisplayMode === 'popover' && (jsx(Popover.Dropdown, { onClick: (event) => event.stopPropagation(), onKeyDown: (event) => event.key === 'Enter' && setPopoverOpened(false), children: jsx(MRT_TableHeadCellFilterContainer, { header: header, table: table }) }))] }) }));
};
...
const MRT_TableHeadCellSortLabel = (_a) => {
    ...
    return (jsx(Tooltip, { label: sortTooltip, openDelay: 1000, withinPortal: true, children: sorting.length < 2 || sortIndex === -1 ? (SortActionButton) : (jsx(Indicator, { className: clsx('mrt-table-head-multi-sort-indicator', classes$c['multi-sort-indicator']), inline: true, label: sortIndex + 1, offset: 4, children: SortActionButton })) }));
};
...
const MRT_ToolbarAlertBanner = (_a) => {
    ...
    return (jsx(Collapse, { in: showAlertBanner || !!selectedAlert || !!groupedAlert, transitionDuration: stackAlertBanner ? 200 : 0, children: jsx(Alert, Object.assign({ color: "blue", icon: false }, alertProps, { className: clsx(classes$a.alert, stackAlertBanner &&
                !positionToolbarAlertBanner &&
...
const MRT_ProgressBar = (_a) => {
    ...
    return (jsx(Collapse, { className: clsx(classes$8.collapse, isTopToolbar && classes$8['collapse-top']), in: isSaving || showProgressBars, children: jsx(Progress, Object.assign({ animated: true, "aria-busy": "true", "aria-label": "Loading", radius: 0, value: 100 }, linearProgressProps)) }));
};
...
const MRT_ToolbarDropZone = (_a) => {
    ...
    return (jsx(Transition, { mounted: showToolbarDropZone, transition: "fade", children: () => {
            var _a, _b;
            return (jsx(Flex, Object.assign({ className: clsx('mrt-toolbar-dropzone', classes$6.root, (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === 'drop-zone' && classes$6.hovered), onDragEnter: handleDragEnter }, rest, { children: jsx(Text, { children: localization.dropToGroupBy.replace('{column}', (_b = (_a = draggingColumn === null || draggingColumn === void 0 ? void 0 : draggingColumn.columnDef) === null || _a === void 0 ? void 0 : _a.header) !== null && _b !== void 0 ? _b : '') }) })));
        } }));
};
...
const MRT_BottomToolbar = (_a) => {
    ...
    return (jsxs(Box, Object.assign({}, toolbarProps, { className: clsx('mrt-bottom-toolbar', classes$9.root, commonClasses['common-toolbar-styles'], isFullScreen && classes$9['root-fullscreen'], toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.className), ref: (node) => {
            if (node) {
...
const MRT_ShowHideColumnsMenuItems = ({ allColumns, column, hoveredColumn, setHoveredColumn, table, }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(Menu.Item, Object.assign({ className: classes$2.root, component: "span", onDragEnter: handleDragEnter, ref: menuItemRef, style: {
                    '--_column-depth': `${(column.depth + 0.5) * 2}rem`,
                    '--_hover-color': getPrimaryColor(theme),
                } }, dataVariable('dragging', isDragging), dataVariable('order-hovered', (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === column.id), { children: jsxs(Box, { className: classes$2.menu, children: [columnDefType !== 'group' &&
                            enableColumnOrdering &&
                            !allColumns.some((col) => col.columnDef.columnDefType === 'group') &&
                            (columnDef.enableColumnOrdering !== false ? (jsx(MRT_GrabHandleButton, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table: table })) : (jsx(Box, { className: classes$2.grab }))), enableColumnPinning &&
                            (column.getCanPin() ? (jsx(MRT_ColumnPinningButtons, { column: column, table: table })) : (jsx(Box, { className: classes$2.pin }))), enableHiding ? (jsx(Tooltip, { label: localization.toggleVisibility, openDelay: 1000, withinPortal: true, children: jsx(Switch, { checked: switchChecked, className: classes$2.switch, disabled: !column.getCanHide(), label: columnDef.header, onChange: () => handleToggleColumnHidden(column) }) })) : (jsx(Text, { className: classes$2.header, children: columnDef.header }))] }) })), (_a = column.columns) === null || _a === void 0 ? void 0 : _a.map((c, i) => (jsx(MRT_ShowHideColumnsMenuItems, { allColumns: allColumns, column: c, hoveredColumn: hoveredColumn, setHoveredColumn: setHoveredColumn, table: table }, `${i}-${c.id}`)))] }));
};
...
const MRT_ToolbarInternalButtons = (_a) => {
    ...
    return (jsx(Flex, Object.assign({}, rest, { className: clsx('mrt-toolbar-internal-buttons', classes$4.root, rest === null || rest === void 0 ? void 0 : rest.className), children: (_b = renderToolbarInternalActions === null || renderToolbarInternalActions === void 0 ? void 0 : renderToolbarInternalActions({ table })) !== null && _b !== void 0 ? _b : (jsxs(Fragment, { children: [enableFilters &&
                    enableGlobalFilter &&
...
const MRT_GlobalFilterTextInput = (_a) => {
    ...
    return (jsxs(Collapse, { className: classes.collapse, in: showGlobalFilter, children: [enableGlobalFilterModes && (jsxs(Menu, { withinPortal: true, children: [jsx(Menu.Target, { children: jsx(ActionIcon, { "aria-label": localization.changeSearchMode, color: "gray", size: "sm", variant: "transparent", children: jsx(IconSearch, {}) }) }), jsx(MRT_FilterOptionMenu, { onSelect: handleClear, table: table })] })), jsx(TextInput, Object.assign({ leftSection: !enableGlobalFilterModes && jsx(IconSearch, {}), mt: 0, mx: "sm", onChange: (event) => setSearchValue(event.target.value), placeholder: localization.search, rightSection: searchValue ? (jsx(ActionIcon, { "aria-label": localization.clearSearch, color: "gray", disabled: !(searchValue === null || searchValue === void 0 ? void 0 : searchValue.length), onClick: handleClear, size: "sm", variant: "transparent", children: jsx(Tooltip, { label: localization.clearSearch, withinPortal: true, children: jsx(IconX, {}) }) })) : null, value: searchValue !== null && searchValue !== void 0 ? searchValue : '', variant: "filled" }, textFieldProps, { className: clsx('mrt-global-filter-text-input', classes.root, textFieldProps === null || textFieldProps === void 0 ? void 0 : textFieldProps.className), ref: (node) => {
                    if (node) {
...
const MRT_TopToolbar = (_a) => {
    ...
    return (jsxs(Box, Object.assign({}, toolbarProps, { className: clsx(commonClasses['common-toolbar-styles'], classes$5['root'], isFullScreen && classes$5['root-fullscreen'], toolbarProps === null || toolbarProps === void 0 ? void 0 : toolbarProps.className), ref: (node) => {
            if (node) {
...
const MRT_TablePaper = (_a) => {
    ...
    return (jsxs(Paper, Object.assign({ shadow: "xs", withBorder: true }, tablePaperProps, { className: clsx('mrt-table-paper', classes$y.root, isFullScreen && 'mrt-table-paper-fullscreen', tablePaperProps === null || tablePaperProps === void 0 ? void 0 : tablePaperProps.className), ref: (ref) => {
